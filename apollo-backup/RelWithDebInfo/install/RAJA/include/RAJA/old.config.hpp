 ...
 ******************************************************************************
 */
#define ENABLE_FORCEINLINE_RECURSIVE
...
#ifndef RAJA_ENABLE_APOLLO
#define RAJA_ENABLE_APOLLO
#endif
/*!
 ******************************************************************************
 *
...
const int RAJA_VERSION_MINOR = 7;
...
#define RAJA_FORCEINLINE_RECURSIVE  _Pragma("forceinline recursive")
#else
